...
class DeleteUser extends JwtAuthorizedController
{
    public function __invoke(
        ...
        $postUser = new RemoveUser($param['id']);
        ...
        return $responseFormat->response(["data" => "Deleted User OK"], Response::HTTP_CREATED);
    }
